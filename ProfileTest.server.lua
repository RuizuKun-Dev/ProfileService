...
task.spawn(function()
	...
	TestUpdateAsync(
		RandomProfileStoreKey1,
		RandomProfileStoreScope1,
		"Profile7",
		function() -- Injecting a faulty profile table
	...
	TestUpdateAsync(
		...
		RandomProfileStoreScope1,
		"Profile8",
		function() -- Injecting profile table of an unreleased session
			return {
				Data = {},
				MetaData = {
					ProfileCreateTime = 0,
	...
	TestUpdateAsync(
		...
		RandomProfileStoreScope1,
		"Profile9",
		function() -- Injecting profile table with force load request
			return {
				Data = {},
				MetaData = {
					ProfileCreateTime = 0,
